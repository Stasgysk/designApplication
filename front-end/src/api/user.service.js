...
export const changePassword = (password) => gsAxios.post('/users/password/change', password);
export const changeUserInfo = (userInfo) => gsAxios.post('/users/change', userInfo);