...
class ProjectScreen extends React.PureComponent {
    ...
    triggerFileDropDown = () => {
        if (this.state.isFileDropDown === true) {
    ...
    onFileChange = async (event) => {
        ...
        if (event.target.files.length > 0) {
            ...
            file.data = await this.convertBase64(event.target.files[0]);
    ...
    triggerPen = () => {
        ...
        if(this.state.isDrawing){
            ...
            document.getElementById("pen").style.backgroundColor = "#555555";
        } else {
            this.setState({isDrawing: true});
            document.getElementById("pen").style.backgroundColor = "#444444";
        }
    }
    ...
    return (
            <div id="main-project-container">
                    ...
                    <div id="project-content">
                        ...
                        <div id="under-project-menu">
                            <div id="left-project-menu">
                                ...
                                <button id="pen" type="button" className="left-menu-button" onClick={this.triggerPen}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                ...
                {this.state.showFilePopUp && <div id="project-pop-up-dimmed">
                </div>
                }
                        ...
                        <div id="project-pop-up-form">
                            <div id="project-pop-up-form-flex">
                                <div id="create-close-project">
                                    ...
                                    <div>
                                        <CloseButton onClick={this.hideFilePopUp}/>
                                    </div>
                                </div>
                                <form onSubmit={this.handleSubmit}>
                                    <input id="file" type="file" ref={this.inputFile} style={{display: 'none'}} onChange={this.onFileChange}/>
                                    <div className="button-container">
                                        <Button className="project-create-button" variant="secondary" onClick={this.openFileOnClick}>Open</Button>
                                    </div>
                                </form>
                            </div>
                        </div>
